...
/**
 * REST controller for managing {@link com.apeiron.paperlabs.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeResource {
    ...
    /**
     * get all the employees by userId.
     *
     * @param userId the userId.
     * @return List of Employees.
     */
    @GetMapping("/employees/user")
    public List<Employee> searchEmployeesByUserId(@RequestParam String userId) {
        log.debug("REST request to get all Employees by user {}",userId);

        return employeeRepository.findAllByUserIdEquals(userId);
