...
@Component({
  selector: 'jhi-component-cdd',
  templateUrl: './component-cdd.component.html',
  styleUrls: ['./component-cdd.component.scss']
})
export class ComponentCddComponent implements OnInit{
