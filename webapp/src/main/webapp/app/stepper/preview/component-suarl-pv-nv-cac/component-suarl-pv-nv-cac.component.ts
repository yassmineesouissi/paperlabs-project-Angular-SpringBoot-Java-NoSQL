...
@Component({
  selector: 'jhi-component-suarl-pv-nv-cac',
  templateUrl: './component-suarl-pv-nv-cac.component.html',
  styleUrls: ['./component-suarl-pv-nv-cac.component.scss']
})
export class ComponentSuarlPVNvCACComponent implements OnInit {
