...
@Component({
  selector: 'jhi-component-convocation-ago',
  templateUrl: './component-convocation-ago.component.html',
  styleUrls: ['./component-convocation-ago.component.scss']
})
export class ComponentConvocationAgoComponent implements OnInit {
