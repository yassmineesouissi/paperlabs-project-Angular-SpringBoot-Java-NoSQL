...
@Component({
  selector: 'jhi-component-nantissement-fdc',
  templateUrl: './component-nantissement-fdc.component.html',
  styleUrls: ['./component-nantissement-fdc.component.scss']
})
export class ComponentNantissementFDCComponent implements OnInit {
