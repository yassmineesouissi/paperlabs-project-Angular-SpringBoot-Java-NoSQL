...
@Component({
  selector: 'jhi-preview-solde-tout-compte',
  templateUrl: './component-solde-tout-compte.component.html',
  styleUrls: ['./component-solde-tout-compte.component.scss']
})
export class ComponentSoldeToutCompteComponent implements OnInit {
