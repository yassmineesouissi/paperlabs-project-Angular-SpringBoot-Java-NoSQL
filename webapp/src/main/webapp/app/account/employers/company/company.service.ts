...
export class CompanyService {
  ...
  public resourceByUserLoginUrl = SERVER_API_URL + 'api/companies/user';
  ...
  searchCompaniesByUser(userId: string, pageNumber: number, itemsPerPage: number): Observable<EntityArrayResponseType> {
    return this.http.get<ICompany[]>(`${this.resourceByUserLoginUrl}/${userId}?pageNumber=${pageNumber}&itemsPerPage=${itemsPerPage}`, {
      observe: 'response'
    });
  }
}
