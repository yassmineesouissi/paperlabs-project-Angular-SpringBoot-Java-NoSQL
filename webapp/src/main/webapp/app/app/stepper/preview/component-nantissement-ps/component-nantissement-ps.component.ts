...
@Component({
  selector: 'jhi-component-nantissement-ps',
  templateUrl: './component-nantissement-ps.component.html',
  styleUrls: ['./component-nantissement-ps.component.scss']
})
export class ComponentNantissementPsComponent implements OnInit {
