...
@Component({
  selector: 'jhi-component-quitance-loyer',
  templateUrl: './component-quitance-loyer.component.html',
  styleUrls: ['./component-quitance-loyer.component.scss']
})
export class ComponentQuitanceLoyerComponent implements OnInit {
