...
@Component({
  selector: 'jhi-component-sivp',
  templateUrl: './component-sivp.component.html',
  styleUrls: ['./component-sivp.component.scss']
})
export class ComponentSivpComponent implements OnInit {
