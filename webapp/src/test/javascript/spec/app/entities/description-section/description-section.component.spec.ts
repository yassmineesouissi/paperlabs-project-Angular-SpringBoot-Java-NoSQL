...
import { DescriptionSectionComponent } from 'app/entities/description-section/description-section.component';
...
describe('Component Tests', () => {
  describe('DescriptionSection Management Component', () => {
    let comp: DescriptionSectionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DescriptionSectionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new DescriptionSection('123')],
            headers
          })
        )
      );
      ...
      expect(comp.descriptionSections[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
