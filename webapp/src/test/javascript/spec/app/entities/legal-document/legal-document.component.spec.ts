...
import { LegalDocumentComponent } from 'app/entities/legal-document/legal-document.component';
...
describe('Component Tests', () => {
  describe('LegalDocument Management Component', () => {
    let comp: LegalDocumentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LegalDocumentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.legalDocuments[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
