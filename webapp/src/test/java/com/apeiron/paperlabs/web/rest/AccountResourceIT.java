...
public class AccountResourceIT {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService, orderService, userMapper);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService, orderService, userMapper);
